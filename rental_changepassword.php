...
?>
<form action="rental_changepassword_action.php" method="post" id="form1">
    <div class="container">
        ...
        <div class="form-group">
            Enter New Password
            <input type="password" class="form-control" id="newwpass" name="newpass" data-rule-required="true"
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" name="connewpass" data-rule-required="true"
                   data-msg-required="Password is Required" data-rule-equalto="#newwpass">
        </div>

        <div class="form-group">
            <input type="submit" value="Change Password" class="btn btn-success" style="background-color: #e3001f">
        </div>
    </div>
