...
<div class="container">
    <form action="publicchecklogin.php" method="post" id="form1">
        <div>
            <h4 class="alert alert-info">Public Login</h4>
        </div>
...
<div class="text-center">
    ...
    if (isset($_REQUEST['er'])) {
        $val = $_REQUEST['er'];
        if ($val == 1) {
            echo '<span class="alert alert-danger">Inavlid Credentials</span>';
        }
    }
    ?>
</div>
